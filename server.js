...
// [جديد] عرض profile.html لملف الطالب
...
// [جديد] 4. نقطة نهاية لجلب بيانات طالب واحد مع سجل الحضور
...
app.listen(PORT, () => {
    ...
    console.log(`(Make sure 'index.html', 'status.html', and 'profile.html' are inside the 'views' folder)`);
});
